...
![天空之岛](docs/images/promo/l3-overview.jpg)
...
- ✅ **v0.2.2（当前）**：HUD 全几何吸附 3px 艺术像素栅格（Safe/面板宽/单元格/右列/队血条/徽章/模式钮，武器面板图标盒 16u）；
...
| 3D 空间模型口径 | [docs/设计/3D空间模型对齐.md](docs/设计/3D空间模型对齐.md) |
