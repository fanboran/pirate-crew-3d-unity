...
竞技场不是平地，而是**悬空平台簇**：梯田岛、放样成型的三桅大帆船、空岛、小艇岛错落在海面上空。伤害不够秒人？没关系——爆炸的击退会把敌人**轰下甲板**，落水即死，没有游泳这个选项。还可以用木箱垒工事、埋火药桶打连锁殉爆。
...
- ✅ **v0.1（当前）**：回合制对战闭环、17/17 武器、击退落水击杀、33 关战役、船员招募/编成、AI 对手、2P 热座、写实 PBR 画面、音效
