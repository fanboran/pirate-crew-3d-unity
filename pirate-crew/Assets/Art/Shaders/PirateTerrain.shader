...
//   【三族贴图】沙/草/岩各一套 albedo+法线（6 张 **512²**（v2 提档前 256²），算法唯一来源 =
...
//   【v2 贴图提档后本 shader 无需改动】贴图 256²→512²、内容由纯 value-FBM 改为**域名扭曲 fBm**：
//     采样口径（世界尺度 / 三族权重混合起伏量 / 法线重定向）全不变，mip 自动适配更细的贴图。
